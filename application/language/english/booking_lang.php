...
$lang['site_contact'] = 'Contact No';
$lang['site_address'] = 'Address';
...
$lang['site_bookingPrice'] = 'Service Price';
...
$lang['site_ShopbookingEmailMsg'] = 'You have a booking. Please see the below information of your booking : <br>'
        . 'Customer Name : {{{customer_name}}} <br/>'
        . 'Check In No : {{{check_in_no}}}<br/>'
        . 'Booking date : {{{b_date}}}<br/>'
        . 'Booking Time : {{{b_time}}} <br/>'
        . 'Service Name : {{{service}}}';

$lang['site_bookingCancelEmailMsg'] = 'You have a booking cancel Request. Please see the below information of your booking : <br>'
        . 'Customer Name : {{{customer_name}}} <br/>'
        . 'Check In No : {{{check_in_no}}}<br/>'
        . 'Booking date : {{{b_date}}}<br/>'
        . 'Booking Time : {{{b_time}}} <br/>'
...
$lang['site_CustomerbookingCancelEmailMsg'] = 'Your booking canceled successfully. Please see the below information of your booking : <br>'
        . 'Customer Name : {{{customer_name}}} <br/>'
        . 'Check In No : {{{check_in_no}}}<br/>'
        . 'Booking date : {{{b_date}}}<br/>'
        . 'Booking Time : {{{b_time}}} <br/>'
...
$lang['site_bookingMsgForShop'] = 'You have a booking! Please see below booking details.';
$lang['site_bookingCancelMsgForShop'] = 'You have a request to cancel a booking! Please see below booking details.';

$lang['site_bookingMsgForCustomer'] = 'Your booking request has been confirmed successfully.If you can’t attend , please cancel the booking or book another timeslot or date.Please see below booking details.';
$lang['site_bookingCancelMsgForCustomer'] = 'Your request to cancel this booking has been confirmed successfully. Please see below booking details.';
